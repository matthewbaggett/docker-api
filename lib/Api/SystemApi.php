...
class SystemApi
{
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\SystemAuthResponse
     *
    ...
    {
        [$response] = $this->systemAuthWithHttpInfo($auth_config, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\SystemDataUsageResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->systemDataUsageWithHttpInfo($type, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\EventMessage
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->systemEventsWithHttpInfo($since, $until, $filters, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\SystemInfo
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->systemInfoWithHttpInfo($contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|string
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->systemPingWithHttpInfo($contentType);
    ...
    {
        [$response] = $this->systemPingHeadWithHttpInfo($contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\SystemVersion
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->systemVersionWithHttpInfo($contentType);
