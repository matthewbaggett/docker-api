...
use MatthewBaggett\Docker\Model\ContainerCreateRequest;
use MatthewBaggett\Docker\Model\ContainerUpdateRequest;
...
class ContainerApi
{
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\FilesystemChange[]
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerChanges'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\FilesystemChange[]|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerChangesWithHttpInfo($id, string $contentType = self::contentTypes['containerChanges'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Model\FilesystemChange[]' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\FilesystemChange[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\FilesystemChange[]', []),
            ...
            $returnType = '\MatthewBaggett\Docker\Model\FilesystemChange[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\FilesystemChange[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ContainerCreateResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string                 $contentType The value for the Content-Type header. Check self::contentTypes['containerCreate'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\ContainerCreateResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerCreateWithHttpInfo($body, $name = null, $platform = null, string $contentType = self::contentTypes['containerCreate'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 201:
                    if ('\MatthewBaggett\Docker\Model\ContainerCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\ContainerCreateResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\ContainerCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Model\ContainerCreateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\ContainerCreateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ContainerInspectResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerInspect'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\ContainerInspectResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerInspectWithHttpInfo($id, $size = false, string $contentType = self::contentTypes['containerInspect'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Model\ContainerInspectResponse' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\ContainerInspectResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\ContainerInspectResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Model\ContainerInspectResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\ContainerInspectResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ContainerSummary[]|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerList'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\ContainerSummary[]|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerListWithHttpInfo($all = false, $limit = null, $size = false, $filters = null, string $contentType = self::contentTypes['containerList'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Model\ContainerSummary[]' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\ContainerSummary[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\ContainerSummary[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Model\ContainerSummary[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\ContainerSummary[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\SplFileObject
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerLogs'] to see the possible values for this operation
     *
     * @return array of \SplFileObject|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ContainerPruneResponse|\MatthewBaggett\Docker\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerPrune'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\ContainerPruneResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerPruneWithHttpInfo($filters = null, string $contentType = self::contentTypes['containerPrune'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Model\ContainerPruneResponse' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\ContainerPruneResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\ContainerPruneResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Model\ContainerPruneResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\ContainerPruneResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|object
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerStats'] to see the possible values for this operation
     *
     * @return array of object|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ContainerTopResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerTop'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\ContainerTopResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerTopWithHttpInfo($id, $ps_args = '-ef', string $contentType = self::contentTypes['containerTop'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Model\ContainerTopResponse' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\ContainerTopResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\ContainerTopResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Model\ContainerTopResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\ContainerTopResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ContainerUpdateResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string                 $contentType The value for the Content-Type header. Check self::contentTypes['containerUpdate'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\ContainerUpdateResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerUpdateWithHttpInfo($id, $update, string $contentType = self::contentTypes['containerUpdate'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Model\ContainerUpdateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\ContainerUpdateResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\ContainerUpdateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Model\ContainerUpdateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\ContainerUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Model\ContainerWaitResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['containerWait'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Model\ContainerWaitResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse|\MatthewBaggett\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function containerWaitWithHttpInfo($id, $condition = 'not-running', string $contentType = self::contentTypes['containerWait'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Model\ContainerWaitResponse' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Model\ContainerWaitResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Model\ContainerWaitResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Model\ContainerWaitResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Model\ContainerWaitResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
