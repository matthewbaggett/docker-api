...
use MatthewBaggett\Docker\Api\Model\ConfigCreateRequest;
use MatthewBaggett\Docker\Api\Model\ConfigSpec;
...
class ConfigApi
{
     ...
     * Create a config
     *
     * @param ConfigCreateRequest $body        body (optional)
    ...
    {
        [$response] = $this->configCreateWithHttpInfo($body, $contentType);
     ...
     * Create a config
     *
     * @param ConfigCreateRequest $body        (optional)
     * @param string              $contentType The value for the Content-Type header. Check self::contentTypes['configCreate'] to see the possible values for this operation
     *
     ...
     * @throws \InvalidArgumentException
     */
    public function configDelete($id, string $contentType = self::contentTypes['configDelete'][0]): void
    {
     ...
     *
     * @return \MatthewBaggett\Docker\Api\Model\Config|\MatthewBaggett\Docker\Api\Model\ErrorResponse|\MatthewBaggett\Docker\Api\Model\ErrorResponse|\MatthewBaggett\Docker\Api\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->configInspectWithHttpInfo($id, $contentType);
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['configInspect'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Api\Model\Config|\MatthewBaggett\Docker\Api\Model\ErrorResponse|\MatthewBaggett\Docker\Api\Model\ErrorResponse|\MatthewBaggett\Docker\Api\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function configInspectWithHttpInfo($id, string $contentType = self::contentTypes['configInspect'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\MatthewBaggett\Docker\Api\Model\Config' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MatthewBaggett\Docker\Api\Model\Config' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MatthewBaggett\Docker\Api\Model\Config', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            ...
            $returnType = '\MatthewBaggett\Docker\Api\Model\Config';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); // stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MatthewBaggett\Docker\Api\Model\Config',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @return \MatthewBaggett\Docker\Api\Model\Config[]|\MatthewBaggett\Docker\Api\Model\ErrorResponse|\MatthewBaggett\Docker\Api\Model\ErrorResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->configListWithHttpInfo($filters, $contentType);
     ...
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['configList'] to see the possible values for this operation
     *
     * @return array of \MatthewBaggett\Docker\Api\Model\Config[]|\MatthewBaggett\Docker\Api\Model\ErrorResponse|\MatthewBaggett\Docker\Api\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param ConfigSpec $body        The spec of the config to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [ConfigInspect endpoint](#operation/ConfigInspect) response values. (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function configUpdate($id, $version, $body = null, string $contentType = self::contentTypes['configUpdate'][0]): void
    {
