...
class ImageApi
{
    ...
    {
        [$response] = $this->buildPruneWithHttpInfo($keep_storage, $all, $filters, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\IdResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imageCommitWithHttpInfo($container, $repo, $tag, $comment, $author, $pause, $changes, $container_config, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function imageCreate($from_image = null, $from_src = null, $repo = null, $tag = null, $message = null, $x_registry_auth = null, $changes = null, $platform = null, $input_image = null, string $contentType = self::contentTypes['imageCreate'][0]): void
    {
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ImageDeleteResponseItem[]
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imageDeleteWithHttpInfo($name, $force, $noprune, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\SplFileObject
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imageGetWithHttpInfo($name, $contentType);
    ...
    {
        [$response] = $this->imageGetAllWithHttpInfo($names, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\HistoryResponseItem[]
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imageHistoryWithHttpInfo($name, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ImageInspect
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imageInspectWithHttpInfo($name, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ImageSummary[]
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imageListWithHttpInfo($all, $filters, $shared_size, $digests, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function imageLoad($quiet = false, $images_tarball = null, string $contentType = self::contentTypes['imageLoad'][0]): void
    {
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ImagePruneResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imagePruneWithHttpInfo($filters, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function imagePush($name, $x_registry_auth, $tag = null, string $contentType = self::contentTypes['imagePush'][0]): void
    {
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ImageSearchResponseItem[]
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->imageSearchWithHttpInfo($term, $limit, $filters, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function imageTag($name, $repo = null, $tag = null, string $contentType = self::contentTypes['imageTag'][0]): void
    {
