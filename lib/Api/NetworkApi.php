...
class NetworkApi
{
     ...
     */
    public function networkConnect($id, $container, string $contentType = self::contentTypes['networkConnect'][0]): void
    {
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\NetworkCreateResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->networkCreateWithHttpInfo($network_config, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function networkDelete($id, string $contentType = self::contentTypes['networkDelete'][0]): void
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function networkDisconnect($id, $container, string $contentType = self::contentTypes['networkDisconnect'][0]): void
    {
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\Network
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->networkInspectWithHttpInfo($id, $verbose, $scope, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\Network[]
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->networkListWithHttpInfo($filters, $contentType);
     ...
     *
     * @return \OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\NetworkPruneResponse
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->networkPruneWithHttpInfo($filters, $contentType);
