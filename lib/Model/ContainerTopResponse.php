 ...
 */
class ContainerTopResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets titles.
     *
     * @param null|string[] $titles The ps column titles
     *
     * @return self
     */
     ...
     * Sets processes.
     *
     * @param null|string[][] $processes each process running in the container, where each is process is an array of values corresponding to the titles
     *
     * @return self
     */
