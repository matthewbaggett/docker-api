...
class ServiceSpecRollbackConfig implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets parallelism.
     *
     * @param null|int $parallelism maximum number of tasks to be rolled back in one iteration (0 means unlimited parallelism)
     *
     * @return self
     */
     ...
     * Sets delay.
     *
     * @param null|int $delay amount of time between rollback iterations, in nanoseconds
     *
     * @return self
     */
     ...
     * Sets failure_action.
     *
     * @param null|string $failure_action action to take if an rolled back task fails to run, or stops running during the rollback
     *
     * @return self
     */
     ...
     * Sets monitor.
     *
     * @param null|int $monitor amount of time to monitor each rolled back task for failures, in nanoseconds
     *
     * @return self
     */
     ...
     *
     * @param null|float $max_failure_ratio the fraction of tasks that may fail during a rollback before the failure action is invoked, specified as a floating point number between 0 and 1
     *
     * @return self
     */
     ...
     * Sets order.
     *
     * @param null|string $order The order of operations when rolling back a task. Either the old task is shut down before the new task is started, or the new task is started before the old task is shut down.
     *
     * @return self
     */
