...
class OCIPlatform implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets architecture.
     *
     * @param null|string $architecture the CPU architecture, for example `amd64` or `ppc64`
     *
     * @return self
     */
     ...
     * Sets os.
     *
     * @param null|string $os the operating system, for example `linux` or `windows`
     *
     * @return self
     */
     ...
     * Sets os_version.
     *
     * @param null|string $os_version Optional field specifying the operating system version, for example on Windows `10.0.19041.1165`.
     *
     * @return self
     */
     ...
     * Sets os_features.
     *
     * @param null|string[] $os_features optional field specifying an array of strings, each listing a required OS feature (for example on Windows `win32k`)
     *
     * @return self
     */
     ...
     * Sets variant.
     *
     * @param null|string $variant optional field specifying a variant of the CPU, for example `v7` to specify ARMv7 when architecture is `arm`
     *
     * @return self
     */
