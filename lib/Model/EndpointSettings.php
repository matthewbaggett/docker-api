...
class EndpointSettings implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'ipam_config'            => '\MatthewBaggett\Docker\Model\EndpointIPAMConfig',
        'links'                  => 'string[]',
        'aliases'                => 'string[]',
        'network_id'             => 'string',
        'endpoint_id'            => 'string',
     ...
     * Gets ipam_config.
     *
     * @return null|EndpointIPAMConfig
     */
     ...
     * Sets ipam_config.
     *
     * @param null|EndpointIPAMConfig $ipam_config ipam_config
     *
     * @return self
     */
     ...
     * Sets network_id.
     *
     * @param null|string $network_id unique ID of the network
     *
     * @return self
     */
     ...
     * Sets endpoint_id.
     *
     * @param null|string $endpoint_id unique ID for the service endpoint in a Sandbox
     *
     * @return self
     */
     ...
     * Sets gateway.
     *
     * @param null|string $gateway gateway address for this network
     *
     * @return self
     */
     ...
     * Sets ip_address.
     *
     * @param null|string $ip_address IPv4 address
     *
     * @return self
     */
     ...
     * Sets ip_prefix_len.
     *
     * @param null|int $ip_prefix_len mask length of the IPv4 address
     *
     * @return self
     */
     ...
     * Sets ipv6_gateway.
     *
     * @param null|string $ipv6_gateway IPv6 gateway address
     *
     * @return self
     */
     ...
     *
     * @param null|string $global_ipv6_address global IPv6 address
     *
     * @return self
     */
     ...
     *
     * @param null|int $global_ipv6_prefix_len mask length of the global IPv6 address
     *
     * @return self
     */
     ...
     * Sets mac_address.
     *
     * @param null|string $mac_address MAC address for the endpoint on this network
     *
     * @return self
     */
     ...
     * Sets driver_opts.
     *
     * @param null|array<string,string> $driver_opts DriverOpts is a mapping of driver options and values. These options are passed directly to the driver and are driver specific.
     *
     * @return self
     */
