...
class Platform implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets architecture.
     *
     * @param null|string $architecture architecture represents the hardware architecture (for example, `x86_64`)
     *
     * @return self
     */
     ...
     * Sets os.
     *
     * @param null|string $os OS represents the Operating System (for example, `linux` or `windows`)
     *
     * @return self
     */
