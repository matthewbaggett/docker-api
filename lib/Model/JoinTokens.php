 ...
 */
class JoinTokens implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets worker.
     *
     * @param null|string $worker the token workers can use to join the swarm
     *
     * @return self
     */
     ...
     * Sets manager.
     *
     * @param null|string $manager the token managers can use to join the swarm
     *
     * @return self
     */
