...
class Address implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('prefix_len', $data ?? [], null);
    }
     ...
     * Sets addr.
     *
     * @param null|string $addr IP address
     *
     * @return self
     */
     ...
     * Sets prefix_len.
     *
     * @param null|int $prefix_len mask length of the IP address
     *
     * @return self
     */
    public function setPrefixLen($prefix_len)
    {
        if (is_null($prefix_len)) {
            throw new \InvalidArgumentException('non-nullable prefix_len cannot be null');
        }
