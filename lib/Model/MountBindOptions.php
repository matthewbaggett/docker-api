...
class MountBindOptions implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets propagation.
     *
     * @param null|string $propagation a propagation mode with the value `[r]private`, `[r]shared`, or `[r]slave`
     *
     * @return self
     */
     ...
     * Sets non_recursive.
     *
     * @param null|bool $non_recursive disable recursive bind mount
     *
     * @return self
     */
     ...
     *
     * @param null|bool $create_mountpoint Create mount point on host if missing
     *
     * @return self
     */
