...
class ExecConfig implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets attach_stdin.
     *
     * @param null|bool $attach_stdin attach to `stdin` of the exec command
     *
     * @return self
     */
     ...
     * Sets attach_stdout.
     *
     * @param null|bool $attach_stdout attach to `stdout` of the exec command
     *
     * @return self
     */
     ...
     * Sets attach_stderr.
     *
     * @param null|bool $attach_stderr attach to `stderr` of the exec command
     *
     * @return self
     */
     ...
     * Sets detach_keys.
     *
     * @param null|string $detach_keys Override the key sequence for detaching a container. Format is a single character `[a-Z]` or `ctrl-<value>` where `<value>` is one of: `a-z`, `@`, `^`, `[`, `,` or `_`.
     *
     * @return self
     */
     ...
     * Sets tty.
     *
     * @param null|bool $tty allocate a pseudo-TTY
     *
     * @return self
     */
     ...
     * Sets cmd.
     *
     * @param null|string[] $cmd command to run, as a string or array of strings
     *
     * @return self
     */
     ...
     * Sets privileged.
     *
     * @param null|bool $privileged runs the exec process with extended privileges
     *
     * @return self
     */
     ...
     * Sets user.
     *
     * @param null|string $user The user, and optionally, group to run the exec process inside the container. Format is one of: `user`, `user:group`, `uid`, or `uid:gid`.
     *
     * @return self
     */
     ...
     * Sets working_dir.
     *
     * @param null|string $working_dir the working directory for the exec process inside the container
     *
     * @return self
     */
