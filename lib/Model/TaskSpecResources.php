...
class TaskSpecResources implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'limits'       => '\OpenAPI\Client\Model\Limit',
        'reservations' => '\OpenAPI\Client\Model\ResourceObject',
    ];
     ...
     * Sets limits.
     *
     * @param null|Limit $limits limits
     *
     * @return self
     */
     ...
     * Sets reservations.
     *
     * @param null|ResourceObject $reservations reservations
     *
     * @return self
     */
