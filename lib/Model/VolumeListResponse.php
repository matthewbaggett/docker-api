...
class VolumeListResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets volumes.
     *
     * @param null|\MatthewBaggett\Docker\Model\Volume[] $volumes List of volumes
     *
     * @return self
     */
     ...
     * Sets warnings.
     *
     * @param null|string[] $warnings warnings that occurred when fetching the list of volumes
     *
     * @return self
     */
