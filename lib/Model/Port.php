...
class Port implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('private_port', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['private_port'] === null) {
            $invalidProperties[] = "'private_port' can't be null";
        }
     ...
     * Sets ip.
     *
     * @param null|string $ip Host IP address that the container's port is mapped to
     *
     * @return self
     */
     ...
     * Sets private_port.
     *
     * @param int $private_port Port on the container
     *
     * @return self
     */
     ...
     * Sets public_port.
     *
     * @param null|int $public_port Port exposed on the host
     *
     * @return self
     */
