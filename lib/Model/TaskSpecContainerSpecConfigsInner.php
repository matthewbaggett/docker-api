...
class TaskSpecContainerSpecConfigsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Gets file.
     *
     * @return null|TaskSpecContainerSpecConfigsInnerFile
     */
     ...
     * Sets file.
     *
     * @param null|TaskSpecContainerSpecConfigsInnerFile $file file
     *
     * @return self
     */
     ...
     * Sets runtime.
     *
     * @param null|object $runtime Runtime represents a target that is not mounted into the container but is used by the task  <p><br /><p>  > **Note**: `Configs.File` and `Configs.Runtime` are mutually > exclusive
     *
     * @return self
     */
     ...
     * Sets config_id.
     *
     * @param null|string $config_id configID represents the ID of the specific config that we're referencing
     *
     * @return self
     */
     ...
     * Sets config_name.
     *
     * @param null|string $config_name ConfigName is the name of the config that this references, but this is just provided for lookup/display purposes. The config in the reference will be identified by its ID.
     *
     * @return self
     */
