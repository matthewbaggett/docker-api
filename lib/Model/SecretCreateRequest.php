...
class SecretCreateRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SecretCreate_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('templating', $data ?? [], null);
    }
     ...
     * Sets name.
     *
     * @param null|string $name user-defined name of the secret
     *
     * @return self
     */
     ...
     * Sets data.
     *
     * @param null|string $data Base64-url-safe-encoded ([RFC 4648](https://tools.ietf.org/html/rfc4648#section-5)) data to store as secret.  This field is only used to _create_ a secret, and is not returned by other endpoints.
     *
     * @return self
     */
     ...
     * Sets driver.
     *
     * @param null|Driver $driver driver
     *
     * @return self
     */
     ...
     * Sets templating.
     *
     * @param null|Driver $templating templating
     *
     * @return self
     */
