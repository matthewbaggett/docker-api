...
class EventMessage implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets type.
     *
     * @param null|string $type The type of object emitting the event
     *
     * @return self
     */
     ...
     * Sets action.
     *
     * @param null|string $action The type of event
     *
     * @return self
     */
     ...
     * Sets actor.
     *
     * @param null|EventActor $actor actor
     *
     * @return self
     */
     ...
     * Sets scope.
     *
     * @param null|string $scope Scope of the event. Engine events are `local` scope. Cluster (Swarm) events are `swarm` scope.
     *
     * @return self
     */
     ...
     * Sets time.
     *
     * @param null|int $time Timestamp of event
     *
     * @return self
     */
     ...
     * Sets time_nano.
     *
     * @param null|int $time_nano Timestamp of event, with nanosecond accuracy
     *
     * @return self
     */
