...
class RestartPolicy implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'name'                => 'setName',
        'maximum_retry_count' => 'setMaximumRetryCount',
    ];
    ...
    protected static $getters = [
        'name'                => 'getName',
        'maximum_retry_count' => 'getMaximumRetryCount',
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('maximum_retry_count', $data ?? [], null);
    }
     ...
     * Sets name.
     *
     * @param null|string $name - Empty string means not to restart - `no` Do not automatically restart - `always` Always restart - `unless-stopped` Restart always except when the user has manually stopped the container - `on-failure` Restart only when the container exit code is non-zero
     *
     * @return self
     */
    ...
    /**
     * Gets maximum_retry_count.
     *
     * @return null|int
     */
    public function getMaximumRetryCount()
    {
        return $this->container['maximum_retry_count'];
    }

    /**
     * Sets maximum_retry_count.
     *
     * @param null|int $maximum_retry_count if `on-failure` is used, the number of times to retry before giving up
     *
     * @return self
     */
