...
class Task implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets id.
     *
     * @param null|string $id the ID of the task
     *
     * @return self
     */
     ...
     * Sets name.
     *
     * @param null|string $name name of the task
     *
     * @return self
     */
     ...
     * Sets service_id.
     *
     * @param null|string $service_id the ID of the service this task is part of
     *
     * @return self
     */
     ...
     * Sets node_id.
     *
     * @param null|string $node_id the ID of the node that this task is on
     *
     * @return self
     */
     ...
     *
     * @return null|\OpenAPI\Client\Model\GenericResourcesInner[]
     */
     ...
     *
     * @param null|\OpenAPI\Client\Model\GenericResourcesInner[] $assigned_generic_resources User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`).
     *
     * @return self
     */
     ...
     * Sets status.
     *
     * @param null|TaskStatus $status status
     *
     * @return self
     */
     ...
     * Sets desired_state.
     *
     * @param null|TaskState $desired_state desired_state
     *
     * @return self
     */
     ...
     * Sets job_iteration.
     *
     * @param null|ObjectVersion $job_iteration job_iteration
     *
     * @return self
     */
