...
class Volume implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'scope'          => 'string',
        'cluster_volume' => '\MatthewBaggett\Docker\Model\ClusterVolume',
        'options'        => 'array<string,string>',
        'usage_data'     => '\MatthewBaggett\Docker\Model\VolumeUsageData',
    ];
    ...
    protected static $setters = [
        ...
        'labels'         => 'setLabels',
        'scope'          => 'setScope',
        'cluster_volume' => 'setClusterVolume',
        'options'        => 'setOptions',
    ...
    protected static $getters = [
        ...
        'labels'         => 'getLabels',
        'scope'          => 'getScope',
        'cluster_volume' => 'getClusterVolume',
        'options'        => 'getOptions',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('scope', $data ?? [], 'local');
        $this->setIfExists('cluster_volume', $data ?? [], null);
     ...
     * Sets created_at.
     *
     * @param null|string $created_at date/Time the volume was created
     *
     * @return self
     */
     ...
     * Sets status.
     *
     * @param null|array<string,object> $status Low-level details about the volume, provided by the volume driver. Details are returned as a map with key/value pairs: `{\"key\":\"value\",\"key2\":\"value2\"}`.  The `Status` field is optional, and is omitted if the volume driver does not support this feature.
     *
     * @return self
     */
     ...
     * Gets cluster_volume.
     *
     * @return null|ClusterVolume
     */
    public function getClusterVolume()
    {
        return $this->container['cluster_volume'];
    }

    /**
     * Sets cluster_volume.
     *
     * @param null|ClusterVolume $cluster_volume cluster_volume
     *
     * @return self
     */
     ...
     * Sets usage_data.
     *
     * @param null|VolumeUsageData $usage_data usage_data
     *
     * @return self
     */
