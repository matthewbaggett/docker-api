...
class VolumeCreateOptions implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'VolumeCreateOptions';
    ...
    protected static $openAPITypes = [
        ...
        'cluster_volume_spec' => '\OpenAPI\Client\Model\ClusterVolumeSpec',
    ];
    ...
    protected static $setters = [
        ...
        'labels'              => 'setLabels',
        'cluster_volume_spec' => 'setClusterVolumeSpec',
    ];
    ...
    protected static $getters = [
        ...
        'labels'              => 'getLabels',
        'cluster_volume_spec' => 'getClusterVolumeSpec',
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('driver', $data ?? [], 'local');
        $this->setIfExists('driver_opts', $data ?? [], null);
        $this->setIfExists('labels', $data ?? [], null);
        $this->setIfExists('cluster_volume_spec', $data ?? [], null);
    }
     ...
     * Sets name.
     *
     * @param null|string $name The new volume's name. If not specified, Docker generates a name.
     *
     * @return self
     */
     ...
     * Sets driver.
     *
     * @param null|string $driver name of the volume driver to use
     *
     * @return self
     */
     ...
     * Sets driver_opts.
     *
     * @param null|array<string,string> $driver_opts A mapping of driver options and values. These options are passed directly to the driver and are driver specific.
     *
     * @return self
     */
    ...
    {
        return $this->container['cluster_volume_spec'];
    }

    /**
     * Sets cluster_volume_spec.
     *
     * @param null|ClusterVolumeSpec $cluster_volume_spec cluster_volume_spec
     *
     * @return self
     */
