...
class ClusterVolumeSpecAccessModeAccessibilityRequirements implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ClusterVolumeSpec_AccessMode_AccessibilityRequirements';
    ...
    {
        $this->setIfExists('requisite', $data ?? [], null);
     ...
     * Sets requisite.
     *
     * @param null|array[] $requisite a list of required topologies, at least one of which the volume must be accessible from
     *
     * @return self
     */
     ...
     * Sets preferred.
     *
     * @param null|array[] $preferred a list of topologies that the volume should attempt to be provisioned in
     *
     * @return self
     */
