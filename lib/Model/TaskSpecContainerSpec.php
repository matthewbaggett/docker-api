...
class TaskSpecContainerSpec implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets image.
     *
     * @param null|string $image The image name to use for the container
     *
     * @return self
     */
     ...
     * Sets labels.
     *
     * @param null|array<string,string> $labels user-defined key/value data
     *
     * @return self
     */
     ...
     * Sets command.
     *
     * @param null|string[] $command the command to be run in the image
     *
     * @return self
     */
     ...
     * Sets args.
     *
     * @param null|string[] $args arguments to the command
     *
     * @return self
     */
     ...
     * Sets hostname.
     *
     * @param null|string $hostname The hostname to use for the container, as a valid [RFC 1123](https://tools.ietf.org/html/rfc1123) hostname.
     *
     * @return self
     */
     ...
     * Sets env.
     *
     * @param null|string[] $env a list of environment variables in the form `VAR=value`
     *
     * @return self
     */
     ...
     * Sets dir.
     *
     * @param null|string $dir the working directory for commands to run in
     *
     * @return self
     */
     ...
     * Sets user.
     *
     * @param null|string $user the user inside the container
     *
     * @return self
     */
     ...
     * Sets groups.
     *
     * @param null|string[] $groups a list of additional groups that the container process will run as
     *
     * @return self
     */
     ...
     * Gets privileges.
     *
     * @return null|TaskSpecContainerSpecPrivileges
     */
     ...
     * Sets privileges.
     *
     * @param null|TaskSpecContainerSpecPrivileges $privileges privileges
     *
     * @return self
     */
     ...
     * Sets tty.
     *
     * @param null|bool $tty whether a pseudo-TTY should be allocated
     *
     * @return self
     */
     ...
     * Sets read_only.
     *
     * @param null|bool $read_only mount the container's root filesystem as read only
     *
     * @return self
     */
     ...
     * Sets mounts.
     *
     * @param null|\OpenAPI\Client\Model\Mount[] $mounts specification for mounts to be added to containers created as part of the service
     *
     * @return self
     */
     ...
     * Sets stop_signal.
     *
     * @param null|string $stop_signal signal to stop the container
     *
     * @return self
     */
     ...
     *
     * @param null|int $stop_grace_period amount of time to wait for the container to terminate before forcefully killing it
     *
     * @return self
     */
     ...
     * Sets health_check.
     *
     * @param null|HealthConfig $health_check health_check
     *
     * @return self
     */
     ...
     * Sets hosts.
     *
     * @param null|string[] $hosts A list of hostname/IP mappings to add to the container's `hosts` file. The format of extra hosts is specified in the [hosts(5)](http://man7.org/linux/man-pages/man5/hosts.5.html) man page:      IP_address canonical_hostname [aliases...]
     *
     * @return self
     */
     ...
     * Gets dns_config.
     *
     * @return null|TaskSpecContainerSpecDNSConfig
     */
     ...
     * Sets dns_config.
     *
     * @param null|TaskSpecContainerSpecDNSConfig $dns_config dns_config
     *
     * @return self
     */
     ...
     * Gets secrets.
     *
     * @return null|\OpenAPI\Client\Model\TaskSpecContainerSpecSecretsInner[]
     */
     ...
     * Sets secrets.
     *
     * @param null|\OpenAPI\Client\Model\TaskSpecContainerSpecSecretsInner[] $secrets secrets contains references to zero or more secrets that will be exposed to the service
     *
     * @return self
     */
     ...
     * Gets configs.
     *
     * @return null|\OpenAPI\Client\Model\TaskSpecContainerSpecConfigsInner[]
     */
     ...
     * Sets configs.
     *
     * @param null|\OpenAPI\Client\Model\TaskSpecContainerSpecConfigsInner[] $configs configs contains references to zero or more configs that will be exposed to the service
     *
     * @return self
     */
     ...
     * Sets isolation.
     *
     * @param null|string $isolation Isolation technology of the containers running the service. (Windows only)
     *
     * @return self
     */
     ...
     * Sets sysctls.
     *
     * @param null|array<string,string> $sysctls Set kernel namedspaced parameters (sysctls) in the container. The Sysctls option on services accepts the same sysctls as the are supported on containers. Note that while the same sysctls are supported, no guarantees or checks are made about their suitability for a clustered environment, and it's up to the user to determine whether a given sysctl will work properly in a Service.
     *
     * @return self
     */
     ...
     * Sets capability_add.
     *
     * @param null|string[] $capability_add a list of kernel capabilities to add to the default set for the container
     *
     * @return self
     */
     ...
     *
     * @param null|string[] $capability_drop a list of kernel capabilities to drop from the default set for the container
     *
     * @return self
     */
