...
class Health implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('failing_streak', $data ?? [], null);
     ...
     * Sets status.
     *
     * @param null|string $status Status is one of `none`, `starting`, `healthy` or `unhealthy`  - \"none\"      Indicates there is no healthcheck - \"starting\"  Starting indicates that the container is not yet ready - \"healthy\"   Healthy indicates that the container is running correctly - \"unhealthy\" Unhealthy indicates that the container has a problem
     *
     * @return self
     */
     ...
     * Sets failing_streak.
     *
     * @param null|int $failing_streak FailingStreak is the number of consecutive failures
     *
     * @return self
     */
     ...
     * Gets log.
     *
     * @return null|\OpenAPI\Client\Model\HealthcheckResult[]
     */
     ...
     * Sets log.
     *
     * @param null|\OpenAPI\Client\Model\HealthcheckResult[] $log Log contains the last few results (oldest first)
     *
     * @return self
     */
