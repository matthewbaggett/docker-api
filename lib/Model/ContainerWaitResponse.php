...
class ContainerWaitResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status_code' => 'int',
        'error'       => '\MatthewBaggett\Docker\Api\Model\ContainerWaitExitError',
    ];
     ...
     * Sets status_code.
     *
     * @param int $status_code Exit code of the container
     *
     * @return self
     */
     ...
     * Gets error.
     *
     * @return null|ContainerWaitExitError
     */
     ...
     * Sets error.
     *
     * @param null|ContainerWaitExitError $error error
     *
     * @return self
     */
