...
class PortBinding implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('host_ip', $data ?? [], null);
        $this->setIfExists('host_port', $data ?? [], null);
    }
     ...
     * Sets host_ip.
     *
     * @param null|string $host_ip host IP address that the container's port is mapped to
     *
     * @return self
     */
     ...
     * Sets host_port.
     *
     * @param null|string $host_port host port number that the container's port is mapped to
     *
     * @return self
     */
