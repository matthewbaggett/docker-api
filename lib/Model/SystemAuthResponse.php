 ...
 */
class SystemAuthResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets identity_token.
     *
     * @param null|string $identity_token An opaque token used to authenticate a user after a successful login
     *
     * @return self
     */
