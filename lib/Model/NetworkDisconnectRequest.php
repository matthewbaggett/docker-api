...
class NetworkDisconnectRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NetworkDisconnectRequest';
     ...
     * Sets container.
     *
     * @param null|string $container the ID or name of the container to disconnect from the network
     *
     * @return self
     */
     ...
     * Sets force.
     *
     * @param null|bool $force force the container to disconnect from the network
     *
     * @return self
     */
