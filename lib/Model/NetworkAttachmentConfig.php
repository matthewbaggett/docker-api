...
class NetworkAttachmentConfig implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets target.
     *
     * @param null|string $target The target network for attachment. Must be a network name or ID.
     *
     * @return self
     */
     ...
     * Sets aliases.
     *
     * @param null|string[] $aliases discoverable alternate names for the service on this network
     *
     * @return self
     */
     ...
     * Sets driver_opts.
     *
     * @param null|array<string,string> $driver_opts driver attachment options for the network target
     *
     * @return self
     */
