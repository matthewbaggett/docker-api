...
class SwarmInitRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets data_path_port.
     *
     * @param null|int $data_path_port DataPathPort specifies the data path port number for data traffic. Acceptable port range is 1024 to 49151. if no port is set or is set to 0, default port 4789 will be used.
     *
     * @return self
     */
     ...
     *
     * @param null|bool $force_new_cluster force creation of a new swarm
     *
     * @return self
     */
