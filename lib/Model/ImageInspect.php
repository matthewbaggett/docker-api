...
class ImageInspect implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets id.
     *
     * @param null|string $id ID is the content-addressable ID of an image.  This identifier is a content-addressable digest calculated from the image's configuration (which includes the digests of layers used by the image).  Note that this digest differs from the `RepoDigests` below, which holds digests of image manifests that reference the image.
     *
     * @return self
     */
     ...
     * Sets repo_tags.
     *
     * @param null|string[] $repo_tags List of image names/tags in the local image cache that reference this image.  Multiple image tags can refer to the same image, and this list may be empty if no tags reference the image, in which case the image is \"untagged\", in which case it can still be referenced by its ID.
     *
     * @return self
     */
     ...
     * Sets parent.
     *
     * @param null|string $parent ID of the parent image.  Depending on how the image was created, this field may be empty and is only set for images that were built/created locally. This field is empty if the image was pulled from an image registry.
     *
     * @return self
     */
     ...
     * Sets comment.
     *
     * @param null|string $comment optional message that was set when committing or importing the image
     *
     * @return self
     */
     ...
     * Sets created.
     *
     * @param null|string $created Date and time at which the image was created, formatted in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.
     *
     * @return self
     */
     ...
     * Sets container.
     *
     * @param null|string $container The ID of the container that was used to create the image.  Depending on how the image was created, this field may be empty.
     *
     * @return self
     */
     ...
     *
     * @param null|ContainerConfig $container_config container_config
     *
     * @return self
     */
     ...
     * Sets docker_version.
     *
     * @param null|string $docker_version The version of Docker that was used to build the image.  Depending on how the image was created, this field may be empty.
     *
     * @return self
     */
     ...
     * Sets author.
     *
     * @param null|string $author name of the author that was specified when committing the image, or as specified through MAINTAINER (deprecated) in the Dockerfile
     *
     * @return self
     */
     ...
     * Sets config.
     *
     * @param null|ContainerConfig $config config
     *
     * @return self
     */
     ...
     * Sets architecture.
     *
     * @param null|string $architecture hardware CPU architecture that the image runs on
     *
     * @return self
     */
     ...
     * Sets variant.
     *
     * @param null|string $variant CPU architecture variant (presently ARM-only)
     *
     * @return self
     */
     ...
     * Sets os.
     *
     * @param null|string $os operating System the image is built to run on
     *
     * @return self
     */
     ...
     * Sets os_version.
     *
     * @param null|string $os_version operating System version the image is built to run on (especially for Windows)
     *
     * @return self
     */
     ...
     * Sets size.
     *
     * @param null|int $size total size of the image including all layers it is composed of
     *
     * @return self
     */
     ...
     * Sets graph_driver.
     *
     * @param null|GraphDriverData $graph_driver graph_driver
     *
     * @return self
     */
     ...
     * Gets root_fs.
     *
     * @return null|ImageInspectRootFS
     */
     ...
     * Sets root_fs.
     *
     * @param null|ImageInspectRootFS $root_fs root_fs
     *
     * @return self
     */
     ...
     * Gets metadata.
     *
     * @return null|ImageInspectMetadata
     */
     ...
     * Sets metadata.
     *
     * @param null|ImageInspectMetadata $metadata metadata
     *
     * @return self
     */
