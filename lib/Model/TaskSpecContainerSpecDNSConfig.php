...
class TaskSpecContainerSpecDNSConfig implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets nameservers.
     *
     * @param null|string[] $nameservers the IP addresses of the name servers
     *
     * @return self
     */
     ...
     * Sets search.
     *
     * @param null|string[] $search a search list for host-name lookup
     *
     * @return self
     */
     ...
     * Sets options.
     *
     * @param null|string[] $options A list of internal resolver variables to be modified (e.g., `debug`, `ndots:3`, etc.).
     *
     * @return self
     */
