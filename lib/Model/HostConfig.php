...
class HostConfig implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'log_config'               => '\MatthewBaggett\Docker\Model\HostConfigAllOfLogConfig',
        'network_mode'             => 'string',
        'port_bindings'            => 'array<string,\MatthewBaggett\Docker\Model\PortBinding[]>',
        'restart_policy'           => '\MatthewBaggett\Docker\Model\RestartPolicy',
        'auto_remove'              => 'bool',
     ...
     * Sets cpu_shares.
     *
     * @param null|int $cpu_shares an integer value representing this container's relative CPU weight versus other containers
     *
     * @return self
     */
     ...
     * Sets memory.
     *
     * @param null|int $memory memory limit in bytes
     *
     * @return self
     */
     ...
     * Sets cgroup_parent.
     *
     * @param null|string $cgroup_parent Path to `cgroups` under which the container's `cgroup` is created. If the path is not absolute, the path is considered to be relative to the `cgroups` path of the init process. Cgroups are created if they do not already exist.
     *
     * @return self
     */
     ...
     * Sets blkio_weight.
     *
     * @param null|int $blkio_weight block IO weight (relative weight)
     *
     * @return self
     */
     ...
     * Sets cpu_period.
     *
     * @param null|int $cpu_period the length of a CPU period in microseconds
     *
     * @return self
     */
     ...
     * Sets cpu_quota.
     *
     * @param null|int $cpu_quota microseconds of CPU time that the container can get in a CPU period
     *
     * @return self
     */
     ...
     *
     * @param null|int $cpu_realtime_period The length of a CPU real-time period in microseconds. Set to 0 to allocate no time allocated to real-time tasks.
     *
     * @return self
     */
     ...
     *
     * @param null|int $cpu_realtime_runtime The length of a CPU real-time runtime in microseconds. Set to 0 to allocate no time allocated to real-time tasks.
     *
     * @return self
     */
     ...
     * Sets cpuset_cpus.
     *
     * @param null|string $cpuset_cpus CPUs in which to allow execution (e.g., `0-3`, `0,1`).
     *
     * @return self
     */
     ...
     * Sets cpuset_mems.
     *
     * @param null|string $cpuset_mems Memory nodes (MEMs) in which to allow execution (0-3, 0,1). Only effective on NUMA systems.
     *
     * @return self
     */
     ...
     *
     * @param null|string[] $device_cgroup_rules a list of cgroup rules to apply to the container
     *
     * @return self
     */
     ...
     *
     * @param null|int $kernel_memory_tcp Hard limit for kernel TCP buffer memory (in bytes). Depending on the OCI runtime in use, this option may be ignored. It is no longer supported by the default (runc) runtime.  This field is omitted when empty.
     *
     * @return self
     */
     ...
     *
     * @param null|int $memory_reservation memory soft limit in bytes
     *
     * @return self
     */
     ...
     * Sets memory_swap.
     *
     * @param null|int $memory_swap Total memory limit (memory + swap). Set as `-1` to enable unlimited swap.
     *
     * @return self
     */
     ...
     *
     * @param null|int $memory_swappiness Tune a container's memory swappiness behavior. Accepts an integer between 0 and 100.
     *
     * @return self
     */
     ...
     * Sets nano_cpus.
     *
     * @param null|int $nano_cpus CPU quota in units of 10<sup>-9</sup> CPUs
     *
     * @return self
     */
     ...
     *
     * @param null|bool $oom_kill_disable disable OOM Killer for the container
     *
     * @return self
     */
     ...
     * Sets init.
     *
     * @param null|bool $init Run an init inside the container that forwards signals and reaps processes. This field is omitted if empty, and the default (as configured on the daemon) is used.
     *
     * @return self
     */
     ...
     * Sets pids_limit.
     *
     * @param null|int $pids_limit Tune a container's PIDs limit. Set `0` or `-1` for unlimited, or `null` to not change.
     *
     * @return self
     */
     ...
     * Sets cpu_count.
     *
     * @param null|int $cpu_count The number of usable CPUs (Windows only).  On Windows Server containers, the processor resource controls are mutually exclusive. The order of precedence is `CPUCount` first, then `CPUShares`, and `CPUPercent` last.
     *
     * @return self
     */
     ...
     * Sets cpu_percent.
     *
     * @param null|int $cpu_percent The usable percentage of the available CPUs (Windows only).  On Windows Server containers, the processor resource controls are mutually exclusive. The order of precedence is `CPUCount` first, then `CPUShares`, and `CPUPercent` last.
     *
     * @return self
     */
     ...
     *
     * @param null|int $io_maximum_i_ops Maximum IOps for the container system drive (Windows only)
     *
     * @return self
     */
     ...
     *
     * @param null|int $io_maximum_bandwidth maximum IO in bytes per second for the container system drive (Windows only)
     *
     * @return self
     */
     ...
     *
     * @param null|string $container_id_file Path to a file where the container ID is written
     *
     * @return self
     */
     ...
     * Gets log_config.
     *
     * @return null|HostConfigAllOfLogConfig
     */
     ...
     * Sets log_config.
     *
     * @param null|HostConfigAllOfLogConfig $log_config log_config
     *
     * @return self
     */
     ...
     * Sets network_mode.
     *
     * @param null|string $network_mode Network mode to use for this container. Supported standard values are: `bridge`, `host`, `none`, and `container:<name|id>`. Any other value is taken as a custom network's name to which this container should connect to.
     *
     * @return self
     */
     ...
     * Sets restart_policy.
     *
     * @param null|RestartPolicy $restart_policy restart_policy
     *
     * @return self
     */
     ...
     * Sets auto_remove.
     *
     * @param null|bool $auto_remove Automatically remove the container when the container's process exits. This has no effect if `RestartPolicy` is set.
     *
     * @return self
     */
     ...
     * Sets volume_driver.
     *
     * @param null|string $volume_driver driver that this container uses to mount volumes
     *
     * @return self
     */
     ...
     * Sets volumes_from.
     *
     * @param null|string[] $volumes_from a list of volumes to inherit from another container, specified in the form `<container name>[:<ro|rw>]`
     *
     * @return self
     */
     ...
     * Sets mounts.
     *
     * @param null|\MatthewBaggett\Docker\Model\Mount[] $mounts specification for mounts to be added to the container
     *
     * @return self
     */
     ...
     * Sets console_size.
     *
     * @param null|int[] $console_size initial console size, as an `[height, width]` array
     *
     * @return self
     */
     ...
     * Sets annotations.
     *
     * @param null|array<string,string> $annotations arbitrary non-identifying metadata attached to container and provided to the runtime when the container is started
     *
     * @return self
     */
     ...
     * Sets cap_add.
     *
     * @param null|string[] $cap_add A list of kernel capabilities to add to the container. Conflicts with option 'Capabilities'.
     *
     * @return self
     */
     ...
     * Sets cap_drop.
     *
     * @param null|string[] $cap_drop A list of kernel capabilities to drop from the container. Conflicts with option 'Capabilities'.
     *
     * @return self
     */
     ...
     * Sets cgroupns_mode.
     *
     * @param null|string $cgroupns_mode cgroup namespace mode for the container. Possible values are:  - `\"private\"`: the container runs in its own private cgroup namespace - `\"host\"`: use the host system's cgroup namespace  If not specified, the daemon default is used, which can either be `\"private\"` or `\"host\"`, depending on daemon version, kernel support and configuration.
     *
     * @return self
     */
     ...
     * Sets dns.
     *
     * @param null|string[] $dns a list of DNS servers for the container to use
     *
     * @return self
     */
     ...
     * Sets dns_options.
     *
     * @param null|string[] $dns_options a list of DNS options
     *
     * @return self
     */
     ...
     * Sets dns_search.
     *
     * @param null|string[] $dns_search a list of DNS search domains
     *
     * @return self
     */
     ...
     * Sets extra_hosts.
     *
     * @param null|string[] $extra_hosts A list of hostnames/IP mappings to add to the container's `/etc/hosts` file. Specified in the form `[\"hostname:IP\"]`.
     *
     * @return self
     */
     ...
     * Sets group_add.
     *
     * @param null|string[] $group_add a list of additional groups that the container process will run as
     *
     * @return self
     */
     ...
     * Sets ipc_mode.
     *
     * @param null|string $ipc_mode IPC sharing mode for the container. Possible values are:  - `\"none\"`: own private IPC namespace, with /dev/shm not mounted - `\"private\"`: own private IPC namespace - `\"shareable\"`: own private IPC namespace, with a possibility to share it with other containers - `\"container:<name|id>\"`: join another (shareable) container's IPC namespace - `\"host\"`: use the host system's IPC namespace  If not specified, daemon default is used, which can either be `\"private\"` or `\"shareable\"`, depending on daemon version and configuration.
     *
     * @return self
     */
     ...
     * Sets cgroup.
     *
     * @param null|string $cgroup cgroup to use for the container
     *
     * @return self
     */
     ...
     * Sets links.
     *
     * @param null|string[] $links a list of links for the container in the form `container_name:alias`
     *
     * @return self
     */
     ...
     * Sets oom_score_adj.
     *
     * @param null|int $oom_score_adj an integer value containing the score given to the container in order to tune OOM killer preferences
     *
     * @return self
     */
     ...
     * Sets pid_mode.
     *
     * @param null|string $pid_mode Set the PID (Process) Namespace mode for the container. It can be either:  - `\"container:<name|id>\"`: joins another container's PID namespace - `\"host\"`: use the host's PID namespace inside the container
     *
     * @return self
     */
     ...
     * Sets privileged.
     *
     * @param null|bool $privileged gives the container full access to the host
     *
     * @return self
     */
     ...
     *
     * @param null|bool $publish_all_ports Allocates an ephemeral host port for all of a container's exposed ports.  Ports are de-allocated when the container stops and allocated when the container starts. The allocated port might be changed when restarting the container.  The port is selected from the ephemeral port range that depends on the kernel. For example, on Linux the range is defined by `/proc/sys/net/ipv4/ip_local_port_range`.
     *
     * @return self
     */
     ...
     *
     * @param null|bool $readonly_rootfs mount the container's root filesystem as read only
     *
     * @return self
     */
     ...
     * Sets security_opt.
     *
     * @param null|string[] $security_opt a list of string values to customize labels for MLS systems, such as SELinux
     *
     * @return self
     */
     ...
     * Sets storage_opt.
     *
     * @param null|array<string,string> $storage_opt storage driver options for this container, in the form `{\"size\": \"120G\"}`
     *
     * @return self
     */
     ...
     * Sets tmpfs.
     *
     * @param null|array<string,string> $tmpfs A map of container directories which should be replaced by tmpfs mounts, and their corresponding mount options. For example:  ``` { \"/run\": \"rw,noexec,nosuid,size=65536k\" } ```
     *
     * @return self
     */
     ...
     * Sets uts_mode.
     *
     * @param null|string $uts_mode UTS namespace to use for the container
     *
     * @return self
     */
     ...
     * Sets userns_mode.
     *
     * @param null|string $userns_mode sets the usernamespace mode for the container when usernamespace remapping option is enabled
     *
     * @return self
     */
     ...
     * Sets shm_size.
     *
     * @param null|int $shm_size Size of `/dev/shm` in bytes. If omitted, the system uses 64MB.
     *
     * @return self
     */
     ...
     * Sets sysctls.
     *
     * @param null|array<string,string> $sysctls A list of kernel parameters (sysctls) to set in the container. For example:  ``` {\"net.ipv4.ip_forward\": \"1\"} ```
     *
     * @return self
     */
     ...
     * Sets runtime.
     *
     * @param null|string $runtime runtime to use with this container
     *
     * @return self
     */
     ...
     * Sets isolation.
     *
     * @param null|string $isolation Isolation technology of the container. (Windows only)
     *
     * @return self
     */
     ...
     * Sets masked_paths.
     *
     * @param null|string[] $masked_paths the list of paths to be masked inside the container (this overrides the default set of paths)
     *
     * @return self
     */
     ...
     * Sets readonly_paths.
     *
     * @param null|string[] $readonly_paths the list of paths to be set as read-only inside the container (this overrides the default set of paths)
     *
     * @return self
     */
