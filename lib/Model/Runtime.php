...
class Runtime implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('runtime_args', $data ?? [], null);
    }
     ...
     * Sets path.
     *
     * @param null|string $path Name and, optional, path, of the OCI executable binary.  If the path is omitted, the daemon searches the host's `$PATH` for the binary and uses the first result.
     *
     * @return self
     */
     ...
     * Sets runtime_args.
     *
     * @param null|string[] $runtime_args list of command-line arguments to pass to the runtime when invoked
     *
     * @return self
     */
    public function setRuntimeArgs($runtime_args)
    {
        if (is_null($runtime_args)) {
