...
class NetworkCreateRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|bool $check_duplicate Check for networks with duplicate names. Since Network is primarily keyed based on a random ID and not on the name, and network name is strictly a user-friendly alias to the network which is uniquely identified using ID, there is no guaranteed way to check for duplicates. CheckDuplicate is there to provide a best effort checking of any networks which has the same name but it is not guaranteed to catch all name collisions.
     *
     * @return self
     */
     ...
     * Sets driver.
     *
     * @param null|string $driver name of the network driver plugin to use
     *
     * @return self
     */
     ...
     * Sets internal.
     *
     * @param null|bool $internal restrict external access to the network
     *
     * @return self
     */
     ...
     * Sets attachable.
     *
     * @param null|bool $attachable globally scoped network is manually attachable by regular containers from workers in swarm mode
     *
     * @return self
     */
     ...
     * Sets ingress.
     *
     * @param null|bool $ingress ingress network is the network which provides the routing-mesh in swarm mode
     *
     * @return self
     */
     ...
     * Sets enable_ipv6.
     *
     * @param null|bool $enable_ipv6 enable IPv6 on the network
     *
     * @return self
     */
     ...
     * Sets options.
     *
     * @param null|array<string,string> $options network specific options to be used by the drivers
     *
     * @return self
     */
