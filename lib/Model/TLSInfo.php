...
class TLSInfo implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'trust_root'             => false,
        'cert_issuer_subject'    => false,
        'cert_issuer_public_key' => false,
    ];
    ...
    {
        $this->setIfExists('trust_root', $data ?? [], null);
        $this->setIfExists('cert_issuer_subject', $data ?? [], null);
        $this->setIfExists('cert_issuer_public_key', $data ?? [], null);
    }
     ...
     * Sets trust_root.
     *
     * @param null|string $trust_root the root CA certificate(s) that are used to validate leaf TLS certificates
     *
     * @return self
     */
     ...
     *
     * @param null|string $cert_issuer_subject the base64-url-safe-encoded raw subject bytes of the issuer
     *
     * @return self
     */
     ...
     *
     * @param null|string $cert_issuer_public_key the base64-url-safe-encoded raw public key bytes of the issuer
     *
     * @return self
     */
