...
class SystemInfo implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|\OpenAPI\Client\Model\GenericResourcesInner[] $generic_resources User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`).
     *
     * @return self
     */
     ...
     * Gets runtimes.
     *
     * @return null|array<string,\OpenAPI\Client\Model\Runtime>
     */
     ...
     *
     * @return null|\OpenAPI\Client\Model\SystemInfoDefaultAddressPoolsInner[]
     */
