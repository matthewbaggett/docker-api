...
class PluginConfigInterface implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'types'           => '\MatthewBaggett\Docker\Model\PluginInterfaceType[]',
        'socket'          => 'string',
    ...
    protected static $setters = [
        'types'           => 'setTypes',
        'socket'          => 'setSocket',
        'protocol_scheme' => 'setProtocolScheme',
    ];
    ...
    protected static $getters = [
        'types'           => 'getTypes',
        'socket'          => 'getSocket',
        'protocol_scheme' => 'getProtocolScheme',
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('protocol_scheme', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['protocol_scheme']) && !in_array($this->container['protocol_scheme'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'protocol_scheme', must be one of '%s'",
                $this->container['protocol_scheme'],
     ...
     * Gets types.
     *
     * @return \MatthewBaggett\Docker\Model\PluginInterfaceType[]
     */
     ...
     * Sets types.
     *
     * @param \MatthewBaggett\Docker\Model\PluginInterfaceType[] $types types
     *
     * @return self
     */
    ...
    /**
     * Gets protocol_scheme.
     *
     * @return null|string
     */
    public function getProtocolScheme()
    {
        return $this->container['protocol_scheme'];
    }

    /**
     * Sets protocol_scheme.
     *
     * @param null|string $protocol_scheme protocol to use for clients connecting to the plugin
     *
     * @return self
     */
    public function setProtocolScheme($protocol_scheme)
    {
        ...
        $this->container['protocol_scheme'] = $protocol_scheme;
