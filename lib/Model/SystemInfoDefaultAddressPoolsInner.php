...
class SystemInfoDefaultAddressPoolsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SystemInfo_DefaultAddressPools_inner';
     ...
     * Sets base.
     *
     * @param null|string $base The network address in CIDR format
     *
     * @return self
     */
     ...
     * Sets size.
     *
     * @param null|int $size The network pool size
     *
     * @return self
     */
