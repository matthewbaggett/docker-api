...
class HealthcheckResult implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets start.
     *
     * @param null|\DateTime $start Date and time at which this check started in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.
     *
     * @return self
     */
     ...
     * Sets end.
     *
     * @param null|string $end Date and time at which this check ended in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.
     *
     * @return self
     */
     ...
     * Sets exit_code.
     *
     * @param null|int $exit_code ExitCode meanings:  - `0` healthy - `1` unhealthy - `2` reserved (considered unhealthy) - other values: error running probe
     *
     * @return self
     */
     ...
     * Sets output.
     *
     * @param null|string $output Output from last check
     *
     * @return self
     */
