...
class ServiceSpecModeReplicatedJob implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('max_concurrent', $data ?? [], 1);
        $this->setIfExists('total_completions', $data ?? [], null);
    }
     ...
     * Sets max_concurrent.
     *
     * @param null|int $max_concurrent the maximum number of replicas to run simultaneously
     *
     * @return self
     */
     ...
     *
     * @param null|int $total_completions The total number of replicas desired to reach the Completed state. If unset, will default to the value of `MaxConcurrent`
     *
     * @return self
     */
