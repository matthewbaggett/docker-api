...
class ManagerStatus implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'leader'       => 'bool',
        'reachability' => '\MatthewBaggett\Docker\Model\Reachability',
        'addr'         => 'string',
    ];
    ...
    {
        $this->setIfExists('leader', $data ?? [], false);
        $this->setIfExists('reachability', $data ?? [], null);
     ...
     * Sets reachability.
     *
     * @param null|Reachability $reachability reachability
     *
     * @return self
     */
     ...
     * Sets addr.
     *
     * @param null|string $addr the IP address and port at which the manager is reachable
     *
     * @return self
     */
