...
class SwarmSpecEncryptionConfig implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'auto_lock_managers' => 'setAutoLockManagers',
    ];
    ...
    protected static $getters = [
        'auto_lock_managers' => 'getAutoLockManagers',
    ];
    ...
    {
        $this->setIfExists('auto_lock_managers', $data ?? [], null);
    }
    ...
    /**
     * Gets auto_lock_managers.
     *
     * @return null|bool
     */
    public function getAutoLockManagers()
    {
        return $this->container['auto_lock_managers'];
    }

    /**
     * Sets auto_lock_managers.
     *
     * @param null|bool $auto_lock_managers if set, generate a key and use it to lock data stored on the managers
     *
     * @return self
     */
