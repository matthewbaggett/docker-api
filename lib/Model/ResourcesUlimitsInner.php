...
class ResourcesUlimitsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Resources_Ulimits_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('soft', $data ?? [], null);
        $this->setIfExists('hard', $data ?? [], null);
    }
     ...
     * Sets name.
     *
     * @param null|string $name Name of ulimit
     *
     * @return self
     */
     ...
     * Sets soft.
     *
     * @param null|int $soft Soft limit
     *
     * @return self
     */
     ...
     * Sets hard.
     *
     * @param null|int $hard Hard limit
     *
     * @return self
     */
