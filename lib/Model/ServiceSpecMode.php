...
class ServiceSpecMode implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'replicated'     => '\OpenAPI\Client\Model\ServiceSpecModeReplicated',
        'global'         => 'object',
        'replicated_job' => '\OpenAPI\Client\Model\ServiceSpecModeReplicatedJob',
        'global_job'     => 'object',
    ];
    ...
    {
        $this->setIfExists('replicated', $data ?? [], null);
        $this->setIfExists('global', $data ?? [], null);
        $this->setIfExists('replicated_job', $data ?? [], null);
        $this->setIfExists('global_job', $data ?? [], null);
    }
     ...
     * Gets replicated.
     *
     * @return null|ServiceSpecModeReplicated
     */
     ...
     * Sets replicated.
     *
     * @param null|ServiceSpecModeReplicated $replicated replicated
     *
     * @return self
     */
     ...
     * Sets global.
     *
     * @param null|object $global global
     *
     * @return self
     */
     ...
     * Gets replicated_job.
     *
     * @return null|ServiceSpecModeReplicatedJob
     */
     ...
     * Sets replicated_job.
     *
     * @param null|ServiceSpecModeReplicatedJob $replicated_job replicated_job
     *
     * @return self
     */
     ...
     * Sets global_job.
     *
     * @param null|object $global_job the mode used for services which run a task to the completed state on each valid node
     *
     * @return self
     */
