...
class DeviceRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets device_ids.
     *
     * @param null|string[] $device_ids device_ids
     *
     * @return self
     */
     ...
     * Sets capabilities.
     *
     * @param null|string[][] $capabilities a list of capabilities; an OR list of AND lists of capabilities
     *
     * @return self
     */
     ...
     * Sets options.
     *
     * @param null|array<string,string> $options Driver-specific options, specified as a key/value pairs. These options are passed directly to the driver.
     *
     * @return self
     */
