...
class BuildCache implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_SOURCE_LOCAL        = 'source.local';
     ...
     * Sets id.
     *
     * @param null|string $id unique ID of the build cache record
     *
     * @return self
     */
     ...
     * Sets parent.
     *
     * @param null|string $parent ID of the parent build cache record.  > **Deprecated**: This field is deprecated, and omitted if empty.
     *
     * @return self
     */
     ...
     * Sets parents.
     *
     * @param null|string[] $parents list of parent build cache record IDs
     *
     * @return self
     */
     ...
     * Sets type.
     *
     * @param null|string $type cache record type
     *
     * @return self
     */
     ...
     * Sets description.
     *
     * @param null|string $description description of the build-step that produced the build cache
     *
     * @return self
     */
     ...
     * Sets in_use.
     *
     * @param null|bool $in_use indicates if the build cache is in use
     *
     * @return self
     */
     ...
     * Sets shared.
     *
     * @param null|bool $shared indicates if the build cache is shared
     *
     * @return self
     */
     ...
     * Sets size.
     *
     * @param null|int $size amount of disk space used by the build cache (in bytes)
     *
     * @return self
     */
     ...
     * Sets created_at.
     *
     * @param null|string $created_at Date and time at which the build cache was created in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.
     *
     * @return self
     */
     ...
     * Sets last_used_at.
     *
     * @param null|string $last_used_at Date and time at which the build cache was last used in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.
     *
     * @return self
     */
     ...
     * Sets usage_count.
     *
     * @param null|int $usage_count usage_count
     *
     * @return self
     */
