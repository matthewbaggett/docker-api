...
class FilesystemChange implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FilesystemChange';
    ...
    protected static $openAPITypes = [
        'path' => 'string',
        'kind' => '\MatthewBaggett\Docker\Api\Model\ChangeType',
    ];
     ...
     * Sets path.
     *
     * @param string $path path to file or directory that has changed
     *
     * @return self
     */
