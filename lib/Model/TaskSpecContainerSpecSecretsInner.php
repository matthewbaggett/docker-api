...
class TaskSpecContainerSpecSecretsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TaskSpec_ContainerSpec_Secrets_inner';
    ...
    protected static $openAPITypes = [
        'file'        => '\OpenAPI\Client\Model\TaskSpecContainerSpecSecretsInnerFile',
        'secret_id'   => 'string',
        'secret_name' => 'string',
    ];
     ...
     * Gets file.
     *
     * @return null|TaskSpecContainerSpecSecretsInnerFile
     */
     ...
     * Sets file.
     *
     * @param null|TaskSpecContainerSpecSecretsInnerFile $file file
     *
     * @return self
     */
     ...
     * Sets secret_id.
     *
     * @param null|string $secret_id secretID represents the ID of the specific secret that we're referencing
     *
     * @return self
     */
     ...
     * Sets secret_name.
     *
     * @param null|string $secret_name SecretName is the name of the secret that this references, but this is just provided for lookup/display purposes. The secret in the reference will be identified by its ID.
     *
     * @return self
     */
