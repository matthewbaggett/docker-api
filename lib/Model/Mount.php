...
class Mount implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'read_only'      => 'bool',
        'consistency'    => 'string',
        'bind_options'   => '\MatthewBaggett\Docker\Model\MountBindOptions',
        'volume_options' => '\MatthewBaggett\Docker\Model\MountVolumeOptions',
        'tmpfs_options'  => '\MatthewBaggett\Docker\Model\MountTmpfsOptions',
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bind_options', $data ?? [], null);
        $this->setIfExists('volume_options', $data ?? [], null);
        $this->setIfExists('tmpfs_options', $data ?? [], null);
    }
     ...
     * Sets target.
     *
     * @param null|string $target container path
     *
     * @return self
     */
     ...
     * Sets source.
     *
     * @param null|string $source Mount source (e.g. a volume name, a host path).
     *
     * @return self
     */
     ...
     * Sets read_only.
     *
     * @param null|bool $read_only whether the mount should be read-only
     *
     * @return self
     */
     ...
     * Sets consistency.
     *
     * @param null|string $consistency the consistency requirement for the mount: `default`, `consistent`, `cached`, or `delegated`
     *
     * @return self
     */
     ...
     * Sets bind_options.
     *
     * @param null|MountBindOptions $bind_options bind_options
     *
     * @return self
     */
     ...
     * Gets volume_options.
     *
     * @return null|MountVolumeOptions
     */
     ...
     * Sets volume_options.
     *
     * @param null|MountVolumeOptions $volume_options volume_options
     *
     * @return self
     */
     ...
     * Sets tmpfs_options.
     *
     * @param null|MountTmpfsOptions $tmpfs_options tmpfs_options
     *
     * @return self
     */
