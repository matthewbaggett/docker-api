...
**log_config** | [**\MatthewBaggett\Docker\Model\HostConfigAllOfLogConfig**](HostConfigAllOfLogConfig.md) |  | [optional]
...
**mounts** | [**\MatthewBaggett\Docker\Model\Mount[]**](Mount.md) | Specification for mounts to be added to the container. | [optional]
