...
**log_config** | [**\MatthewBaggett\Docker\Api\Model\HostConfigAllOfLogConfig**](HostConfigAllOfLogConfig.md) |  | [optional]
...
**mounts** | [**\MatthewBaggett\Docker\Api\Model\Mount[]**](Mount.md) | Specification for mounts to be added to the container. | [optional]
