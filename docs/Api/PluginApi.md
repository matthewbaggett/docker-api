# MatthewBaggett\Docker\PluginApi
...
```php
getPluginPrivileges($remote): \MatthewBaggett\Docker\Model\PluginPrivilege[]
```
...
$apiInstance = new MatthewBaggett\Docker\Api\PluginApi(
...
[**\MatthewBaggett\Docker\Model\PluginPrivilege[]**](../Model/PluginPrivilege.md)
...
```php
pluginDelete($name, $force): \MatthewBaggett\Docker\Model\Plugin
```
...
[**\MatthewBaggett\Docker\Model\Plugin**](../Model/Plugin.md)
...
```php
pluginInspect($name): \MatthewBaggett\Docker\Model\Plugin
```
...
```php
pluginList($filters): \MatthewBaggett\Docker\Model\Plugin[]
```
...
$body = array(new \MatthewBaggett\Docker\Model\PluginPrivilege()); // \MatthewBaggett\Docker\Model\PluginPrivilege[]
...
| **body** | [**\MatthewBaggett\Docker\Model\PluginPrivilege[]**](../Model/PluginPrivilege.md)|  | [optional] |
