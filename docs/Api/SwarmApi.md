# MatthewBaggett\Docker\SwarmApi
...
$apiInstance = new MatthewBaggett\Docker\Api\SwarmApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$body = new \MatthewBaggett\Docker\Model\SwarmInitRequest(); // \MatthewBaggett\Docker\Model\SwarmInitRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\MatthewBaggett\Docker\Model\SwarmInitRequest**](../Model/SwarmInitRequest.md)|  | |
...
```php
swarmInspect(): \MatthewBaggett\Docker\Model\Swarm
```
...
[**\MatthewBaggett\Docker\Model\Swarm**](../Model/Swarm.md)
...
$body = new \MatthewBaggett\Docker\Model\SwarmJoinRequest(); // \MatthewBaggett\Docker\Model\SwarmJoinRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\MatthewBaggett\Docker\Model\SwarmJoinRequest**](../Model/SwarmJoinRequest.md)|  | |
...
$body = new \MatthewBaggett\Docker\Model\SwarmUnlockRequest(); // \MatthewBaggett\Docker\Model\SwarmUnlockRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\MatthewBaggett\Docker\Model\SwarmUnlockRequest**](../Model/SwarmUnlockRequest.md)|  | |
...
```php
swarmUnlockkey(): \MatthewBaggett\Docker\Model\UnlockKeyResponse
```
...
[**\MatthewBaggett\Docker\Model\UnlockKeyResponse**](../Model/UnlockKeyResponse.md)
...
$body = new \MatthewBaggett\Docker\Model\SwarmSpec(); // \MatthewBaggett\Docker\Model\SwarmSpec
...
| **body** | [**\MatthewBaggett\Docker\Model\SwarmSpec**](../Model/SwarmSpec.md)|  | |
